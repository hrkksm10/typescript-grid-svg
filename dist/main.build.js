...
(function (glob, factory) {
    ...
    if (typeof define == "function" && define.amd) {
        ...
        define('snapsvg',["eve"], function (eve) {
...
define('paper',["require", "exports", "snapsvg"], function (require, exports, Snap) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var paper = Snap(800, 600).remove();
    exports.default = paper;
});
//# sourceMappingURL=paper.js.map;
define('point',["require", "exports", "paper"], function (require, exports, paper_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var Point = (function () {
        function Point(x, y) {
            this.element = paper_1.default.rect(x, y, 20, 20).attr({ fill: 'red', cursor: 'move' });
            this.element.drag(this.onMove, this.onStart, this.onEnd, this, this, this);
        }
        Point.prototype.onStart = function (_x, _y, _event) {
            console.log('start');
        };
        Point.prototype.onMove = function (_dx, _dy, x, y, _event) {
            var matrix = Snap.matrix(paper_1.default.node.getScreenCTM().inverse());
            var sx = matrix.x(x, y);
            var sy = matrix.y(x, y);
            this.element.attr({ x: ~~(sx / 20) * 20, y: ~~(sy / 20) * 20 });
        };
        Point.prototype.onEnd = function (_event) {
            console.log('end');
        };
        return Point;
    }());
...
define('app',["require", "exports", "paper", "point"], function (require, exports, paper_1, point_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var App = (function () {
        function App() {
        ...
        App.prototype.render = function () {
            ...
            paper_1.default.appendTo(body[0]);
            for (var y = 20; y < 600; y += 20) {
                for (var x = 20; x < 800; x += 20) {
                    paper_1.default.circle(x, y, 1.4).attr({ fill: 'black' });
                }
            }
            var r = paper_1.default.rect(0, 0, 800, 600).attr({ fill: '#bbb', opacity: 0.2 });
            r.dblclick(function (_event, x, y) {
                var matrix = Snap.matrix(paper_1.default.node.getScreenCTM().inverse());
                var sx = matrix.x(x, y);
                var sy = matrix.y(x, y);
                new point_1.default(~~(sx / 20) * 20, ~~(sy / 20) * 20);
            });
        };
        return App;
    }());
